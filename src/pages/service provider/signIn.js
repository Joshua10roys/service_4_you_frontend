...
function ServiceProviderSignIn({ alertSnackbar, setSignIn }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (value) => {
            ...
            axios({
                method: "POST",
                url: `${SERVER_URL}/serviceProvider/signIn`,
        ...
        <>
            ...
            <Box className="background">
                <Paper elevation={24} sx={{ p: 4, borderRadius: 2, width: "300px" }}>
                    ...
                    {/* sign up */}
                    <Button
                        onClick={() => navigate("/serviceProvider/signUp")}
                    ...
                    {/* forgot Password */}
                    <Button
                        onClick={() => navigate("/serviceProvider/forgotPassword")}
